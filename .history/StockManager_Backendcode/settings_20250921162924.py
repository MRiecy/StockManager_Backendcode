...
INSTALLED_APPS = [
    # 'django.contrib.admin',  # 暂时注释，避免依赖问题
    'django.contrib.auth',
...
XT_CONFIG = {
    ...
    'TOKEN': os.getenv('XT_TOKEN', '9739566d35ecf79aba74d1e76ebb019c071c7080'),
    'ADDR_LIST': [
...
# 资产对比模块缓存配置
CACHE_ROOT = os.path.join(BASE_DIR, 'data', 'cache')  # Parquet文件存储根目录
