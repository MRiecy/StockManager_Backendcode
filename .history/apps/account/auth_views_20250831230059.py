...
from .models import VerificationCode, UserToken
...
from .sms_service import send_verification_code, get_sms_provider_info
...
def send_verification_code_api(request):
    ...
    try:
        ...
        # 使用真实短信服务发送验证码
        success, message = send_verification_code(phone, verification_code.code)
