...
from .auth_views import (
    send_verification_code_api, login_with_phone, refresh_token,
    logout, get_current_user, get_region_data, get_sms_status
)
...
urlpatterns = [
    ...
    # 短信服务相关接口
    path('sms/status/', get_sms_status, name='get_sms_status'),
