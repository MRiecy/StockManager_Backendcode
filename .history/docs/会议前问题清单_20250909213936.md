...
> 用于下次会议前对齐范围、确认方案与数据链路。文档中引用的“截图占位”请在会前将实际图片替换至 `docs/images/` 目录，并保持编号一致。
...
截图占位：
- [图1] 登录报错提示（用户名和密码不能为空） — 放置于 `docs/images/shot-01-login-error.png`
...
截图占位：
- [图2] 浏览器控制台/网络面板中的登录请求与响应 — `docs/images/shot-02-network-login.png`
...
截图占位：
- [图3] 对比评估页“资产对比/收益率(%)”曲线 — `docs/images/shot-03-chart-asset-compare.png`
- [图4] 对比评估页“表格数据” — `docs/images/shot-04-table-asset-compare.png`
- [图5] 对比评估页“风险因子”面板 — `docs/images/shot-05-risk-panels.png`
- [图6] QMT 户号 `40000326` 持仓界面 — `docs/images/shot-06-qmt-positions.png`
...
---
占位图列表：图1 ~ 图6 请按编号放入 `docs/images/`，会前替换为实际截图。 